...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React, _, PropTypes) {"use strict";
	...
	var AddTodo = function (_React$Component) {
	  ...
	  _createClass(AddTodo, [{
	    ...
	    value: function addTodo(e) {
	      e.preventDefault();
	      var current = this.textInput.current;
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement("input", { placeholder: "your item", ref: this.textInput }),
	          React.createElement(
	            "button",
	            { type: "submit" },
	            "Add Item"
	        ...
	        React.createElement(
	          "ul",
	          { className: "toDolist" },
	          todos.length ? _.map(todos, function (todo, key) {
	            return React.createElement(
	              "li",
	              { className: "toDolistItem", key: key },
	              key + 1,
	              ")",
	              todo.text
	            );
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, { addTodo: _actions.addTodo })(AddTodo);
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(61), __webpack_require__(28)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _todoReducer = __webpack_require__(64);
	...
	exports.default = (0, _redux.combineReducers)({
	  ToDoItem: _todoReducer2.default
	});
